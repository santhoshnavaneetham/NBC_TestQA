...
public class ExtentReporter {
	...
	private static synchronized ExtentReports getReportInstance(ITestResult iTestResult) {
		...
		if (extentReport == null) {
			...
			if (!reportFile.exists())
				try {reportFile.createNewFile();} catch (IOException e) {}
			...
			htmlReporter.config().setJS("$(document).ready(function() {\r\n" + 
					...
					"													}\r\n" + 
					"									}\r\n" + 
					"									if (elementNode.hasAttribute('data-src')) {\r\n" + 
					"													currentSrc = elementNode.getAttribute('data-src');\r\n" + 
					"													if (currentSrc !== \"\" && currentSrc != null) {\r\n" + 
					"																	currentSrc = currentSrc.split(\"ScreenShot\");\r\n" + 
					"																	newSrc = \".\\\\ScreenShot\" + currentSrc[currentSrc.length-1];\r\n" + 
					"																	elementNode.setAttribute('data-src', newSrc);\r\n" + 
					"													}\r\n" + 
					"									}\r\n" + 
					"									if (elementNode.hasAttribute('data-featherlight')) {\r\n" + 
					"													currentSrc = elementNode.getAttribute('data-featherlight');\r\n" + 
					"													if (currentSrc !== \"\" && currentSrc != null) {\r\n" + 
					"																	currentSrc = currentSrc.split(\"ScreenShot\");\r\n" + 
					"																	newSrc = \".\\\\ScreenShot\" + currentSrc[currentSrc.length-1];\r\n" + 
					"																	elementNode.setAttribute('data-featherlight', newSrc);\r\n" + 
					"													}\r\n" + 
					"									}\r\n" + 
					"					}\r\n" + 
					"				});\r\n" + 
	 ...
	 * 
	 * @param message: Description
	 * @param screenshotPath64Bit: ScreenshotPath
	 * @throws IOException 
	 */
	public static void infoBase64(String message, String screenshotPath64Bit) throws IOException {
		if (getTest() != null)
			getTest().info(message, MediaEntityBuilder.createScreenCaptureFromBase64String(screenshotPath64Bit).build());  
	}
	 ...
	 * @throws IOException 
	 */
	public static void passBase64(String passMessage, String screenshotPath64) throws IOException {
		if (getTest() != null)
			getTest().pass("<font color=\"green\">" + passMessage + "</font>", MediaEntityBuilder.createScreenCaptureFromBase64String(screenshotPath64).build());//log(Status.PASS, "<font color=\"green\">" + passMessage + "</font>" + getTest().addScreenCaptureFromPath(screenshotPath));
	}
	 ...
	 * @throws IOException 
	 */
	public static void failBase64(String failMessage, String screenshotPath64) throws IOException {
		if (getTest() != null)
			getTest().fail("<font color=\"red\">" + failMessage + "</font>", MediaEntityBuilder.createScreenCaptureFromBase64String(screenshotPath64).build());//log(Status.FAIL, "<font color=\"red\">" + failMessage + "</font>" + getTest().addScreenCaptureFromPath(screenshotPath));
	}
	 ...
	 * @throws IOException 
	 */
	public static void errorBase64(String errorMessage, String screenshotPath64) throws IOException {
		if (getTest() != null)
		{
			try
			{
			...
			getTest().error("<font color=\"red\">" + errorMessage + "</font>", MediaEntityBuilder.createScreenCaptureFromBase64String(screenshotPath64).build());
		}
	}
	 ...
	 * @throws IOException 
	 */
	public static void skipBase64(String message, String screenshotPath64) throws IOException {
		if (getTest() != null)
			getTest().skip("<font color=\"orange\">" + message + "</font>", MediaEntityBuilder.createScreenCaptureFromBase64String(screenshotPath64).build());//log(Status.SKIP, "<font color=\"orange\">" + message + "</font>" + getTest().addScreenCaptureFromPath(screenshotPath));
	}
